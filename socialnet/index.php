...
?>
    ...
    <style>
        ...
        .btn-accept:hover { background-color: #36a420; }
    ...
    <div class="user-grid">
        <?php foreach ($friends as $u): ?>
            <div class="user-card">
                <h4>
                    <a href="profile.php?owner=<?php echo urlencode($u['username']); ?>" style="color: #1877f2; text-decoration: none;">
        ...
        <?php foreach ($pending_received as $u): ?>
            <div class="user-card">
                ...
                <form action="acceptfriend.php" method="POST">
                    ...
                    <button type="submit" class="btn-action btn-accept">Chấp nhận</button>
                </form>
            </div>
        <?php endforeach; ?>
    </div>
